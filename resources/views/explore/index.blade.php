...
{{-- bipul --}}
  ...
  .products {
    grid-template-columns: repeat(2, 1fr); /* or 3 if you want more in a row */
    gap: 10px;
  }
  ...
  .extra-products {
    ...
    <div class="containerr">
        ...
        <div class="contentt">
            <section id="men"
                style="background-image: none; background-repeat: none; background-size: none;">
                <!--<h4>Women Ethnic</h4>-->
                ...
                <div class="products">
                    ...
                    <div class="product-wrapper">
                        <div class="product">
                            <img src="{{ $men3 }}" alt="Kidswear">
                            <h4>BottomWear</h4>
                        </div>
                        <div class="extra-products">
                            <a href="/category/{{ urlencode(Crypt::encryptString('18')) }}"
                                style="text-decoration:none;">
                                <div class="product">
                                    <img src="{{ $menbottom1 }}" alt="Extra 1">
                                    <p>Jeans</p>
                                </div>
                            </a>
                            <a href="/category/{{ urlencode(Crypt::encryptString('19')) }}"
                                style="text-decoration:none;">
                                <div class="product">
                                    <img src="{{ $menbottom2 }}" alt="Extra 2">
                                    <p>Trousers</p>
                                </div>
                            </a>
                            <a href="/category/{{ urlencode(Crypt::encryptString('20')) }}"
                                style="text-decoration:none;">
                                <div class="product">
                                    <img src="{{ $menbottom3 }}" alt="Extra 3">
                                    <p>Track pants & Joggers</p>
                                </div>
                            </a>
                            <a href="/category/{{ urlencode(Crypt::encryptString('21')) }}"
                                style="text-decoration:none;">
                                <div class="product">
                                    <img src="{{ $menbottom4 }}" alt="Extra 3">
                                    <p>Shorts</p>
                                </div>
                            </a>
                            <a href="/category/{{ urlencode(Crypt::encryptString('22')) }}"
                                style="text-decoration:none;">
                                <div class="product">
                                    <img src="{{ $menbottom5 }}" alt="Extra 3">
            ...
            <div class="products">
                   <div class="product-wrapper">
                        ...
                        <a href="/category/{{ urlencode(Crypt::encryptString('25')) }}" style="text-decoration:none;">
                            <div class="product">
                                <img src="{{ $menfoot2 }}" alt="Extra 2">
                                <p>Casual Shoes</p>
                            </div>
                        </a>
                        <a href="/category/{{ urlencode(Crypt::encryptString('26')) }}" style="text-decoration:none;">
                            <div class="product">
                                <img src="{{ $menfoot3 }}" alt="Extra 3">
                                <p>Formal Shoes</p>
                            </div>
                            <a href="/category/{{ urlencode(Crypt::encryptString('27')) }}"
                                style="text-decoration:none;">
                                <div class="product">
                                    <img src="{{ $menfoot4 }}" alt="Extra 3">
                                    <p>Sneakers</p>
                                </div>
                            </a>
                            <a href="/category/{{ urlencode(Crypt::encryptString('28')) }}"
                                style="text-decoration:none;">
                                <div class="product">
                                    <img src="{{ $menfoot5 }}" alt="Extra 3">
                                    <p>Sport Shoes</p>
                                </div>
                            </a>
                            <a href="/category/{{ urlencode(Crypt::encryptString('29')) }}"
                                style="text-decoration:none;">
                                <div class="product">
                                    <img src="{{ $menfoot6 }}" alt="Extra 3">
                                    <p>Loafers</p>
                                </div>
                            </a>
                            <a href="/category/{{ urlencode(Crypt::encryptString('30')) }}"
                                style="text-decoration:none;">
                                <div class="product">
                                    <img src="{{ $menfoot7 }}" alt="Extra 3">
                                    <p>Socks</p>
                                </div>
                            </a>
                    </div>
 ...
 <div class="product-wrapper">
    ...
    <script>
        ...
        const observerOptions = {
            ...
            threshold: 0.45 // Trigger when at least 50% of the section is in view
        };
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            function setupSection(sectionId) {
                ...
                allWrappers.forEach((wrapper, index) => {
                    ...
                    let extraProductsContent = extraProductsElement ? extraProductsElement.innerHTML
                    .trim() : "";
